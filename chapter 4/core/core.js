...
const randomHouseEvents = [{
    empty: 'Пустоват дом, но что-то лежит на столе',
    mess: 'Ох, какой беспорядок, о, что-то вижу!',
...
function house(bg, key, id) {
    ...
    switch (houseEvent) {
        case 0:
            ...
            dialogs.innerHTML = `
                <div class="row dialog">
                    <p class="lead" id="text-dialog">${randomHouseEvents[0].empty}</p>
                </div>
        ...
        case 1:
            ...
            dialogs.innerHTML = `
                <div class="row dialog">
                    <p class="lead" id="text-dialog">${randomHouseEvents[0].mess}</p>
                </div>
        ...
        case 2:
            ...
            dialogs.innerHTML = `
                <div class="row dialog">
                    <p class="lead" id="text-dialog">${randomHouseEvents[0].default}</p>
                </div>
