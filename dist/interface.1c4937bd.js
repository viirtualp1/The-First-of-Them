...
},{}],"modules/conclusion.js":[function(require,module,exports) {
"use strict";
...
function chooseAction(initialGameSettings) {
  var variants = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [positive, neutral, unpositive];
  var chooseText = document.createElement('p');
  chooseText.className = 'choose-action-text';
  chooseText.innerText = 'Выбери: ';
  var chooseActionBtns = document.createElement('div');
  chooseActionBtns.className = 'd-flex justify-content-center';
  ...
  var chooseActionDiv = document.createElement('div');
  chooseActionDiv.className = 'choose-action-div';
  chooseActionDiv.appendChild(chooseText);
  chooseActionDiv.appendChild(chooseActionBtns);
  initialGameSettings.elements.chooseActions.appendChild(chooseActionDiv);
}
},{}],"js/interface.js":[function(require,module,exports) {
"use strict";

var _core = require("../core/core.js");

var _conclusion = require("../modules/conclusion.js");

var dialogs = document.querySelector('#dialogs');
var chooseDialogs = document.querySelector('#chooseDialog');
var fromWho = document.querySelector('#fromWho');
var context = {
  heroes: {
    hero1: {
      name: 'Василий',
...
(0, _conclusion.chooseAction)(_core.initialGameSettings, [{
  text: 'Привет!',
  func: function func() {
    alert('Hello!');
  }
...
},{"../core/core.js":"core/core.js","../modules/conclusion.js":"modules/conclusion.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/interface.js"], null)
//# sourceMappingURL=/interface.1c4937bd.js.map