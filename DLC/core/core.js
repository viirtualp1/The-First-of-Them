...
/**
 * @param settings Parameters for the game.
 * @param settings.array Array with dialogs.
 * @param settings.heroes Objects with heroes.
 * @param settings.heroes.heroN Hero object
 * @param settings.heroes.heroN.name Name of hero
 * @param settings.heroes.heroN.hp Hp of hero
 */
...
// Choose dialog
function chooseDialog({ positive, neutral, unpositive }) {
  console.log(positive.func());
  initialGameSettings.elements.chooseDialogs.innerHTML = `
        <div id="chooseDialogDiv">
            ...
            <div class="row dialog d-flex justify-content-center" id="chooseDialogDiv">
                <button id="btn-dialog-1" type="button" class="btn btn-dark mt-1 mb-2 ml-2 mr-2" onclick="${positive.func()}">
                    ${positive.text}
                </button>
                <button id="btn-dialog-2" type="button" class="btn btn-dark mt-1 mb-2" onclick="${neutral.func()}">
                    ${neutral.text}
                </button>
                <button id="btn-dialog-3" type="button" class="btn btn-dark mt-1 mb-2 mr-2 ml-2" onclick="${
                  unpositive.func
                }">
                    ${unpositive.text}
                </button>
